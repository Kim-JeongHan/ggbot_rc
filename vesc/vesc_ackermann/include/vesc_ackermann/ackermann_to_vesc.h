...
private:
  ...
  // ROS callbacks
  void ackermannCmdCallback(const ackermann_msgs::AckermannDriveStamped::ConstPtr& cmd_1);
  // void ackermannCmdInit(const ackermann_msgs::AckermannDriveStamped::ConstPtr& cmd);
};
