...
//add
// struct AckermannMsgPtr cmd_1 = {drive.steering_angle = -0.0, drive.steering_angle_velocity = 0.0, drive.speed = 0.0, drive.acceleration = 0.0, drive.jerk = 0.0};
// // AckermannToVesc::ackermannCmdCallback(&cmd_1)

// //struct ackermann_msgs::AckermannDriveStamped::ConstPtr cmd_1;
// //const AckermannMsgPtr cmd_1;
// ackermann_msgs::AckermannDriveStamped::ConstPtr cmd_1(new ackermann_msgs::AckermannDriveStamped);



// ackermann_msgs::AckermannDriveStamped cmd_1;

// cmd_1.drive.steering_angle = -0.0;
// cmd_1.drive.steering_angle_velocity = 0.0;
// cmd_1.drive.speed = 0.0;
// cmd_1.drive.acceleration = 0.0;
// cmd_1.jerk = 0.0;
...
// erpm_msg->data = speed_to_erpm_gain_ * cmd_1->drive.speed + speed_to_erpm_offset_;
// // calc steering angle (servo)
// std_msgs::Float64::Ptr servo_msg(new std_msgs::Float64);
// servo_msg->data = steering_to_servo_gain_ * cmd_1->drive.steering_angle + steering_to_servo_offset_;
